...
class GradeUpdateSchema(Schema):
    ...
    def recalculate_percentage_and_grade(self, data, **kwargs):
        ...
        if (
            ...
            and hasattr(kwargs, "context")
            and "exam" in kwargs.context
        ):
...
class GradeListSchema(Schema):
    ...
    exam = fields.Nested(
        "ExamSchema", only=("id", "title", "exam_date", "total_marks"), dump_only=True
    )
