...
class Attendance(db.Model):
    ...
    __table_args__ = (
        UniqueConstraint(
            "student_id", "class_id", "date", name="uq_attendance_student_class_date"
        ),
    )
    ...
    student = db.relationship(
        "Student", back_populates="attendances", passive_deletes=True
    )
    ...
    recorder = db.relationship(
        "User", backref="recorded_attendances", foreign_keys=[recorded_by]
