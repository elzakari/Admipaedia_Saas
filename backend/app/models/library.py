...
class Book(db.Model):
    ...
    reservations = relationship(
        "BookReservation", back_populates="book", lazy="dynamic"
    )
    ...
    def update_availability(self):
        ...
        active_borrows = self.borrow_records.filter_by(
...
class LibraryMember(db.Model):
    ...
    borrow_records = relationship(
        "BorrowRecord", back_populates="member", lazy="dynamic"
    )
    reservations = relationship(
        "BookReservation", back_populates="member", lazy="dynamic"
    )
...
class BorrowRecord(db.Model):
    ...
    fine_records = relationship(
        "FineRecord", back_populates="borrow_record", lazy="dynamic"
    )
...
class FineRecord(db.Model):
    ...
    def __repr__(self):
        return (
            f"<FineRecord {self.fine_type} - ${self.amount} - {self.member.member_id}>"
        )
