...
class FeeDiscount(db.Model):
    ...
    # Applicability
    fee_category_id = db.Column(
        db.Integer, db.ForeignKey("fee_categories.id"), nullable=True
    )  # If None, applies to total
...
class StudentFee(db.Model):
    ...
    fee_structure_id = db.Column(
        db.Integer, db.ForeignKey("fee_structures.id"), nullable=False
    )
    branch_id = db.Column(
    ...
    # Discount applied
    applied_discount_id = db.Column(
        db.Integer, db.ForeignKey("fee_discounts.id"), nullable=True
    )
...
class PaymentAllocation(db.Model):
    ...
    payment_id = db.Column(
        db.Integer, db.ForeignKey("student_payments.id"), nullable=False
    )
    student_fee_id = db.Column(
        db.Integer, db.ForeignKey("student_fees.id"), nullable=False
    )
