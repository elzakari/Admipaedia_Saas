    ...
    try:
        ...
        for dept_name in default_departments:
            try:
                ...
                print(
                    f"Created department: {dept_name} with code {code} (ID: {dept_id})"
                )
        ...
        conn.commit()
        print(
            f"Department creation complete. Created {len(department_mapping)} departments."
        )
            ...
            for dept_name in default_departments:
                try:
                    ...
                    department = Department(
                        name=dept_name,
                        code=code,
                        description=f"Default department: {dept_name}",
                    )
...
if __name__ == "__main__":
    ...
    if check_column_exists(app, "subjects", "department"):
        ...
        print(
            "The 'department' column still exists in the 'subjects' table. Running migration..."
        )
        try:
            ...
            try:
                ...
                print(
                    f"Direct connection approach failed: {e}\nTrying with app context..."
                )
        ...
        print(
            "The 'department' column does not exist in the 'subjects' table. Creating departments from scratch..."
        )
        try:
            # Try both approaches - first with direct connection, then with app context if that fails
            try:
