...
def get_student_analytics(student_id):
    ...
    try:
        ...
        if not academic_year:
            return (
                jsonify({"success": False, "message": "academic_year is required"}),
                400,
            )
        ...
        if "error" in analytics:
            return jsonify({"success": False, "message": analytics["error"]}), 400
            ...
            jsonify(
                {
                    ...
                    "data": {
                        ...
                        "weighting": {"continuous_assessment": 40, "external_exam": 60},
