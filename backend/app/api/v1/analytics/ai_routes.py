...
def get_student_performance_prediction(student_id: int):
    ...
    try:
        ...
        return error_response(
            message="Failed to generate performance prediction", details=str(e)
        )
...
def get_student_risk_assessment(student_id: int):
    ...
    try:
        ...
        return success_response(
            data=assessment_data, message="Risk assessment completed successfully"
        )

    except Exception as e:
        logger.error(f"Error generating risk assessment: {str(e)}")
        return error_response(
            message="Failed to generate risk assessment", details=str(e)
        )
...
def get_class_performance_predictions(class_id: int):
    ...
    try:
        ...
        return error_response(
            message="Failed to generate class predictions", details=str(e)
        )
...
def get_school_wide_insights():
    ...
    try:
        ...
        return success_response(
            data=insights, message="School-wide insights generated successfully"
        )

    except Exception as e:
        logger.error(f"Error generating school insights: {str(e)}")
        return error_response(
            message="Failed to generate school insights", details=str(e)
        )
...
def get_ai_recommendations(student_id: int):
    ...
    try:
        recommendation_type = request.args.get(
            "type", "all"
        )  # academic, behavioral, attendance, all

        recommendations = AIAnalyticsService.generate_student_recommendations(
            student_id=student_id, recommendation_type=recommendation_type
        )

        return success_response(
            data=recommendations, message="AI recommendations generated successfully"
        )

    except Exception as e:
        logger.error(f"Error generating recommendations: {str(e)}")
        return error_response(
            message="Failed to generate recommendations", details=str(e)
        )
...
def analyze_attendance_patterns():
    ...
    try:
        ...
        patterns = AIAnalyticsService.analyze_attendance_patterns(
            class_id=class_id, student_id=student_id, period_days=period_days
        )

        return success_response(
            data=patterns, message="Attendance patterns analyzed successfully"
        )

    except Exception as e:
        logger.error(f"Error analyzing attendance patterns: {str(e)}")
        return error_response(
            message="Failed to analyze attendance patterns", details=str(e)
        )
...
def detect_performance_anomalies():
    ...
    try:
        ...
        anomalies = AIAnalyticsService.detect_performance_anomalies(
            class_id=class_id, subject_id=subject_id, sensitivity=sensitivity
        )

        return success_response(
            data=anomalies, message="Performance anomalies detected successfully"
        )

    except Exception as e:
        logger.error(f"Error detecting anomalies: {str(e)}")
        return error_response(message="Failed to detect anomalies", details=str(e))
...
def forecast_enrollment():
    ...
    try:
        ...
        return success_response(
            data=forecast_data, message="Enrollment forecast generated successfully"
        )

    except Exception as e:
        logger.error(f"Error forecasting enrollment: {str(e)}")
        return error_response(message="Failed to forecast enrollment", details=str(e))
...
def optimize_resource_allocation():
    ...
    try:
        resource_type = request.args.get(
            "type", "all"
        )  # teachers, classrooms, materials, all
        ...
        return success_response(
            data=optimization, message="Resource allocation optimization completed"
        )

    except Exception as e:
        logger.error(f"Error optimizing resources: {str(e)}")
        return error_response(
            message="Failed to optimize resource allocation", details=str(e)
        )
...
def analyze_teacher_performance():
    ...
    try:
        ...
        analysis = AIAnalyticsService.analyze_teacher_performance(
            teacher_id=teacher_id, analysis_period=analysis_period
        )

        return success_response(
            data=analysis, message="Teacher performance analysis completed"
        )

    except Exception as e:
        logger.error(f"Error analyzing teacher performance: {str(e)}")
        return error_response(
            message="Failed to analyze teacher performance", details=str(e)
        )
...
def batch_predictions():
    ...
    try:
        ...
        return success_response(
            data=batch_results, message="Batch predictions generated successfully"
        )

    except Exception as e:
        logger.error(f"Error generating batch predictions: {str(e)}")
        return error_response(
            message="Failed to generate batch predictions", details=str(e)
        )
...
def retrain_ai_models():
    ...
    try:
        ...
        return success_response(
            data=retrain_results, message="AI models retrained successfully"
        )

    except Exception as e:
        logger.error(f"Error retraining models: {str(e)}")
        return error_response(message="Failed to retrain AI models", details=str(e))
...
def get_ai_dashboard_summary():
    ...
    try:
        ...
        summary = AIAnalyticsService.generate_dashboard_summary(
            user_role=user_role, class_id=class_id
        )

        return success_response(
            data=summary, message="AI dashboard summary generated successfully"
        )

    except Exception as e:
        logger.error(f"Error generating AI summary: {str(e)}")
        return error_response(
            message="Failed to generate AI dashboard summary", details=str(e)
        )
...
def internal_error(error):
    return error_response(
        message="Internal server error in AI Analytics", status_code=500
    )
