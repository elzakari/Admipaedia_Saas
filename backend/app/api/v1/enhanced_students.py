...
# To this
enhanced_students_bp = Blueprint(
    "enhanced_students", __name__, url_prefix="/enhanced-students"
)
...
def create_student_with_user():
    ...
    try:
        ...
        return success_response(
            data=result, message="Student created successfully with user account"
        )
    ...
    try:
        ...
        if export_format.lower() == "csv":
            ...
            return error_response(
                "Unsupported export format. Use 'csv' or 'excel'.", 400
            )
...
def link_student_to_parent(student_id):
    ...
    try:
        ...
        result = StudentSchema().dump(student)
        return success_response(
            data=result, message="Student linked to parent successfully"
        )
...
def generate_student_report(student_id):
    ...
    try:
        ...
        report, error = EnhancedStudentService.generate_student_report(
            student_id, report_type
        )
        if error:
            return error_response(error, 400)

        return success_response(
            data=report, message="Student report generated successfully"
        )
...
def get_analytics_summary():
    ...
    try:
        ...
        return success_response(
            data=summary, message="Analytics summary retrieved successfully"
        )
