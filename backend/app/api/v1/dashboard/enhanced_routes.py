...
def get_performance_trends():
    ...
    try:
        ...
        if user_role == "admin":
            trends = {
                "performance_trends": analytics.get("performance_overview", {}).get(
                    "trends", []
                ),
                "attendance_trends": analytics.get("attendance_analytics", {}).get(
                    "daily_trends", []
                ),
                "grade_distribution_trends": analytics.get(
                    "grade_distribution", {}
                ).get("monthly_trends", []),
            }
        elif user_role == "teacher":
            trends = {
                "class_performance_trends": analytics.get("class_performance", {}).get(
                    "trends", []
                ),
