...
from .routes import (create_backup_v2, delete_backup_v2, export_audit_logs_v2,
                     get_academic_settings_v2, get_admission_price,
                     get_ai_settings_v2, get_audit_filter_options_v2,
                     get_audit_logs_v2, get_audit_stats_v2,
                     get_backup_history_v2, get_backup_schedule_v2,
                     get_backup_settings_v2, get_general_settings_v2,
                     get_integration_settings_v2, get_integration_tests_v2,
                     get_notification_settings_v2, get_school_settings_v2,
                     get_security_settings_v2, get_settings,
                     get_theme_settings_v2, restore_backup_v2,
                     test_email_configuration_v2, test_integration_v2,
                     test_sms_configuration_v2, update_academic_settings_v2,
                     update_ai_settings_v2, update_backup_settings_v2,
                     update_general_settings_v2,
                     update_integration_settings_v2,
                     update_notification_settings_v2,
                     update_school_settings_v2, update_security_settings_v2,
                     update_setting, update_theme_settings_v2)
...
settings_bp.route("/notifications/test-email", methods=["POST"])(
    test_email_configuration_v2
)
settings_bp.route("/notifications/test-sms", methods=["POST"])(
