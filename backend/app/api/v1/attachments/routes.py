        ...
        if not is_admin:
            ...
            if entity_type == "message":
                ...
                if msg and (
                    ...
                    or msg.recipient_id == current_user_id
                ):
                    authorized = True
                ...
                if assignment:
                    ...
                    if teacher_profile and assignment.teacher_id == teacher_profile.id:
                        ...
                        if (
                            student_profile
                            and student_profile.class_id == assignment.class_id
                        ):
                            authorized = True
                        else:
                            ...
                            if parent_profile:
                                ...
                                if any(
                                    c.class_id == assignment.class_id for c in children
                                ):
                                    authorized = True
                ...
                if submission and submission.assignment:
                    ...
                    if (
                        ...
                        if (
                            student_profile
                            and submission.student_id == student_profile.id
                        ):
                            authorized = True
                        else:
                            parent_profile = Parent.query.filter_by(
                ...
                if announcement:
                    ...
                    if (
                        teacher_profile
                        and announcement.teacher_id == teacher_profile.id
                    ):
                        authorized = True
                    else:
                        student_profile = Student.query.filter_by(
                        ...
                        if (
                            student_profile
                            and student_profile.class_id == announcement.class_id
                        ):
                            authorized = True
                        else:
                            parent_profile = Parent.query.filter_by(
                            ...
                            if parent_profile:
                                ...
                                if any(
                                    c.class_id == announcement.class_id
                                    for c in children
                                ):
                                    authorized = True
