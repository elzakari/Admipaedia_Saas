...
class PerformanceMonitoringService:
            ...
            metrics = {
                "cpu": {
                    ...
                    "status": (
                        "high"
                        if cpu_percent > 80
                        else "medium" if cpu_percent > 60 else "normal"
                    ),
                },
                "memory": {
                    ...
                    "status": (
                        ...
                        else "medium" if memory_percent > 70 else "normal"
                    ),
                },
                "disk": {
                    ...
                    "status": (
                        "high"
                        if disk_percent > 90
                        else "medium" if disk_percent > 75 else "normal"
                    ),
                },
                "network": {
        ...
        try:
            ...
            metrics = {
                ...
                "status": (
                    ...
                    else "medium" if connection_time > 50 else "fast"
                ),
                "timestamp": datetime.utcnow().isoformat(),
            }
            ...
            self._store_metric(
                "db_active_connections", active_connections, "count", "database"
            )
        ...
        try:
            ...
            metrics = {
                ...
                "status": (
                    "excellent"
                    if hit_rate > 90
                    else "good" if hit_rate > 70 else "needs_improvement"
                ),
                "timestamp": datetime.utcnow().isoformat(),
            }
            ...
            self._store_metric(
                "cache_total_keys", cache_stats.get("keys", 0), "count", "cache"
            )
    ...
    def get_application_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            metrics = {
                ...
                "user_distribution": {
                    "students": round(
                        (total_students / total_users * 100) if total_users > 0 else 0,
                        1,
                    ),
                    "teachers": round(
                        (total_teachers / total_users * 100) if total_users > 0 else 0,
                        1,
                    ),
                    "others": round(
                        (
    ...
    def _store_metric(
        self, name: str, value: float, unit: str, category: str, metadata: Dict = None
    ):
    ...
    def _generate_performance_summary(self) -> Dict[str, str]:
        ...
        try:
            ...
            return {
                ...
                "memory_status": system_metrics.get("memory", {}).get(
                    "status", "unknown"
                ),
