...
class AttendanceService:
    ...
    def get_attendance_stats(
        class_id=None, student_id=None, date_from=None, date_to=None
    ):
        ...
        try:
            ...
            if result["total"] > 0:
                ...
                result["excused_percentage"] = (
                    result["excused"] / result["total"]
                ) * 100
            else:
    ...
    def get_at_risk_students(class_id=None, threshold=80):
        ...
        try:
            ...
            query = db.session.query(
                Student, subquery.c.total_days, subquery.c.present_days
        ...
        try:
            ...
            for item in attendance_data_list:
                try:
                    ...
                    errors.append(
                        {"student_id": item.get("student_id"), "error": str(e)}
                    )
