...
class CurriculumService:
    ...
    def get_all_curricula(
        page=1, per_page=20, subject_id=None, grade_level=None, academic_year=None
    ):
        ...
        return query.order_by(desc(Curriculum.created_at)).paginate(
    ...
    def get_curriculum_units(curriculum_id):
        ...
        return (
            CurriculumUnit.query.filter_by(curriculum_id=curriculum_id)
            .order_by(CurriculumUnit.sequence_order)
            .all()
        )
