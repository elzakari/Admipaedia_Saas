...
from app.models.dashboard import (CalendarEvent, DashboardStatistic,
                                  Notification)
    ...
    def get_calendar_events(month=None, year=None, start_date=None, end_date=None):
        ...
        try:
            ...
            if month is not None and year is not None:
                ...
                query = query.filter(
                    and_(
                        extract("month", CalendarEvent.date)
    ...
    def generate_default_statistics():
        ...
        try:
            ...
            try:
                ...
                attendance_rate = round(
                    (attendance_count / total_attendance * 100)
            ...
            try:
                ...
                logger.error(
                    "failed_committing_default_statistics", error=str(commit_err)
                )
                db.session.rollback()
