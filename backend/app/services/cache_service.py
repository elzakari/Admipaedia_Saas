...
class CacheService:
    ...
    def cache_user_permissions(
        self, user_id: int, permissions: List[str], ttl: int = None
    ) -> bool:
    ...
    def cache_class_data(
        self, class_id: int, class_data: Dict, ttl: int = None
    ) -> bool:
        """Cache class data"""
    ...
    def cache_analytics_data(
        self, analytics_key: str, data: Dict, ttl: int = None
    ) -> bool:
