  ...
  return (
    <div className="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800/50 rounded-lg p-4">
      <div className="flex items-center mb-3">
        ...
        <h3 className="text-sm font-medium text-indigo-700 dark:text-indigo-300">{t('admin_fees.fee_insights', 'Aperçu des frais')}</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-800 rounded-lg p-3 shadow-sm border border-gray-100 dark:border-slate-700">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400">{t('admin_fees.collection_rate_title', 'Taux de collecte')}</p>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg p-3 shadow-sm border border-gray-100 dark:border-slate-700">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400">{t('admin_fees.payments_7days', 'Paiements (7 jours)')}</p>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg p-3 shadow-sm border border-gray-100 dark:border-slate-700">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400">{t('admin_fees.overdue_records', 'Dossiers en retard')}</p>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg p-3 shadow-sm border border-gray-100 dark:border-slate-700">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-xs text-gray-500 dark:text-gray-400">{t('admin_fees.outstanding_balance', 'Solde impayé')}</p>
