...
export function TeacherFormModal({ isOpen, onClose, teacher }: TeacherFormModalProps) {
  ...
  const buildDefaultValues = (currentTeacher?: Teacher): FormData => ({
    firstName: currentTeacher?.firstName || currentTeacher?.first_name || '',
    middleName: (currentTeacher as any)?.middleName || '',
    lastName: currentTeacher?.lastName || currentTeacher?.last_name || '',
    email: currentTeacher?.email || '',
    phone: currentTeacher?.phone || currentTeacher?.phoneNumber || (currentTeacher as any)?.phone_number || '',
    address: currentTeacher?.address || '',
    dateOfBirth: currentTeacher?.dateOfBirth || currentTeacher?.date_of_birth || '',
    ...
    employeeId: currentTeacher?.employeeId || currentTeacher?.employee_id || '',
