        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="text-sm font-semibold text-slate-900 dark:text-slate-100">{user?.username || 'Teacher'}</div>
            </div>
            <div>
              <div className="text-xs text-slate-500">Role</div>
              <div className="text-sm font-semibold text-slate-900 dark:text-slate-100 capitalize">{user?.role || 'teacher'}</div>
            </div>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          ...
          <Select value={language} onValueChange={onChangeLanguage}>
            <SelectTrigger id="teacher-preferred-language" className="max-w-sm">
