...
const ThemeSettings = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl font-bold tracking-tight">Theme & Appearance</h2>
        <p className="text-gray-500 dark:text-gray-400">Customize the look and feel of your ADMIPAEDIA</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow space-y-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">Customize accessibility preferences</p>
        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">Enable or disable UI animations</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input 
                type="checkbox" 
