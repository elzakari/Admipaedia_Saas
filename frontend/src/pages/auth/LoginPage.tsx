        ...
        <div className="w-full max-w-md">
          <div className="bg-white/90 backdrop-blur rounded-2xl shadow-2xl ring-1 ring-black/5 p-6 sm:p-8">
            ...
            <div className="text-center mb-6">
              <h1 className="text-3xl font-display font-bold text-slate-900 tracking-tight">{t('auth.sign_in', 'Sign in')}</h1>
              <p className="mt-2 text-sm text-slate-600">{t('auth.sign_in_subtitle', 'Sign in to your account to continue')}</p>
            </div>
